Bài tập môn: Xây dựng ứng dụng app đồng hồ
...
- Chức năng chính:
  + Hiển thị thời gian: 
    ...
    + Có thể xem giờ các thành phố  (ví dụ: New York).
  + Báo thức
    + Cho phép người dùng thiết lập giờ, phút.
    + Kích hoạt báo thức bằng nút “Đặt báo thức”.
    + Có thể hủy báo thức đã đặt.
  +Bấm giờ (Stopwatch)
